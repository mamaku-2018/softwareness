...
test('<CategoryMaleFemale> includes correct text', () => {
  ...
  const wrapper = shallow(<CategoryMaleFemale dispatch={() => {}} />)
...
test('<CategoryMaleFemale> is including props passed in', () => {
  ...
  const wrapper = mount(<CategoryMaleFemale gender={gender} dispatch={() => {}} />)
...
test('<CategoryLocalForeign> includes correct text', () => {
  ...
  const wrapper = shallow(<CategoryForeignLocal dispatch={() => {}} local={[]} />)
...
test('<CategoryLocalForeign> is including props passed in', () => {
  ...
  const wrapper = mount(<CategoryForeignLocal local={local} dispatch={() => {}} />)
